...
$fecha_ingreso_db=$mostrar['fecha_inicio'];
$n_expediente=$mostrar['n_expediente'];
$anio_expediente=$mostrar['anio_expediente'];
$fecha_tratamiento_db=$mostrar['fecha_tratamiento'];
$orden_tratamiento=$mostrar['orden_expediente'];
$tipo_expediente=$mostrar['tipo_expediente'];
$descripcion_expediente=$mostrar['descripcion_expediente'];
}

//$originalDate = "2017-03-08";
//$newDate = date("d/m/Y", strtotime($originalDate));
$fecha_ingreso = date("d/m/Y", strtotime($fecha_ingreso_db));
$fecha_tratamiento = date("d/m/Y", strtotime($fecha_tratamiento_db));


$sql2="SELECT * from expediente_detalle WHERE id_expediente=$id_expediente ";
$result2=mysqli_query($datos_conexion,$sql2);
while($mostrar2=mysqli_fetch_array($result2)){
$titulo_expediente=$mostrar2['titulo_expediente'];
$bloque=$mostrar2['autor_expediente'];
$testimonio=$mostrar2['cuerpo_expediente'];
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="card card-primary">
                ...
                <div class="card-body">
                  <form action="editar_expediente2.php?cod=<?php echo $id_expediente; ?>" method="post">
                  <!--<form action="editar_expediente.php?cod=<?php echo $id_expediente; ?>" method="post"> -->
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask required name="fecha_ingreso" value="<?php echo $fecha_ingreso;?>">
                      </div>
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        ...
                        <div class="form-group">
                          ...
                          <input type="number" class="form-control" placeholder="Numero Exp ..." required name="numero_expediente" value="<?php echo $n_expediente;?>">
                        </div>
                      </div>
                      <div class="col-sm-6">
                        <div class="form-group">
                          <label>Año</label>
                          <input type="number" min="1950" max="2099" class="form-control" placeholder="XXXX..." name="anio_expediente" required  value="<?php echo $anio_expediente;?>">
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask required name="fecha_tratamiento" value="<?php echo $fecha_tratamiento;?>">
                      </div>
                      <!-- /.input group -->
                    </div>
                      </div>
                      <div class="col-sm-6">
                        <div class="form-group">
                          <label>Orden de Tratamiento</label>
                          <input type="number" min="1" class="form-control" placeholder="XXXX..." name="orden_tratamiento" value="1" value="<?php echo $orden_tratamiento;?>">
                        </div>
                      </div>
                    ...
                    <div class="form-group">
                      ...
                      <select class="custom-select" name="tipo_expediente" required >
                        <option><?php echo $tipo_expediente;?></option>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" id="inputName" class="form-control" name="titulo_expediente" required value="<?php echo $titulo_expediente;?>">
                    </div>
                    <div class="form-group">
                      <label for="inputName1">Descripcion breve</label>
                      <input type="text" id="inputName1" class="form-control" placeholder="50 caracteres ..." name="descripcion_expediente" required value="<?php echo $descripcion_expediente;?>" >
                    </div>

                    <div class="form-group">
                      <label>Bloque</label>
                      <select class="custom-select" name="bloque_autor" required>
                        <option><?php echo $bloque;?></option>
                        <option>Juntos</option>
                        <option>Frente de todos</option>
                        <option>Avanza Libertad</option>
              ...
              <div class="col-12">
                ...
                <div class="form-group">
                  ...
                  <div class="float-left">
                    <!--<a class="btn btn-danger float" href="finalizar_sesion.php">Finalizar Sesión</a>-->
                    <a class="btn btn-default float-left" href="presidente_e.php"><i class="fas fa-times" ></i> Cancelar Edición</a>
                    <!--<button type="reset" class="btn btn-default float-left"><i class="fas fa-times"></i> Valores originales</button>-->
                  </div>
                </div>
